...
export default ({ navigation, route }): React.ReactElement => {
    ...
    const getSubText = years => {
        var courses = 0;
        years.course.forEach(element => {
            courses = courses + element.lessons.length;
        });
        return (
            <View>
                ...
                <Text numberOfLines={1}>
                    {years.course.length + ' ' + LANG.getTranslation('courses')}
                </Text>
                <Text numberOfLines={1}>
                    {courses + ' ' + LANG.getTranslation('lessons')}
                </Text>
            </View>
        );
    };
