...
module.exports = StyleSheet.create({
    ...
    view_albums_img_big: {
        width: moderateScale(220, ratio_channel),
        height: moderateScale(220, ratio_channel),
    ...
    modalContentMenu: {
        ...
        alignItems: 'center',
        alignContent: 'center',
        height: GLOBAL.Device_IsPhone ? 100 : 200,
        width: GLOBAL.Device_IsPhone ? 320 : 500,
        borderWidth: 1,
    ...
    player_channel_icon: {
        width: moderateScale(
            GLOBAL.Device_IsPhone || GLOBAL.Device_IsTablet ? 35 : 60,
            ratio_channel,
        ),
        height: moderateScale(
            GLOBAL.Device_IsPhone || GLOBAL.Device_IsTablet ? 35 : 60,
    ...
    player_channel_icon_catchup: {
        width: moderateScale(
            GLOBAL.Device_IsPhone || GLOBAL.Device_IsTablet ? 35 : 50,
            ratio_channel,
        ),
        height: moderateScale(
            GLOBAL.Device_IsPhone || GLOBAL.Device_IsTablet ? 35 : 50,
    ...
    player_button_epg: {
        ...
        width: GLOBAL.Device_IsTablet
            ? 80
            : GLOBAL.Device_IsWebTV || GLOBAL.Device_IsAppleTV
            ? 140
            : 90,
        height: GLOBAL.Device_IsTablet
            ? 80
            : GLOBAL.Device_IsWebTV || GLOBAL.Device_IsAppleTV
            ? 140
            : 90,
    ...
    weather_icon: {
        alignSelf: 'center',
        justifyContent: 'center',
        width: moderateScale(25, ratio_general),
        height: moderateScale(25, ratio_general),
        //flex:1
    },
    epg_button_icon: {
        alignSelf: 'center',
    ...
    view_movies_poster_img_: {
        width: moderateScale(
            GLOBAL.Device_IsSmallScreen ? 80 : 150,
            ratio_movie_w,
        ),
        height:
            moderateScale(
