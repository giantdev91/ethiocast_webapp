...
export default class Home extends Component {
    ...
    _startSelectedChannel(item, index, favorite) {
        if (favorite == true) {
            ...
            var foundIt = false;
            GLOBAL.Channels.forEach((category, index_) => {
                category.channels.forEach((channel, index__) => {
                    if (index_ != 1) {
                        if (
                            ...
                            GLOBAL.Channels_Selected = category.channels;
                            GLOBAL.Channels_Selected_Category_ID = category.id;
                            GLOBAL.Channels_Selected_Index = index__;
                            GLOBAL.Channel = channel;
                            GLOBAL.Channels_Selected_Category_Index = index_;
                        }
                    }
                });
            });
                                ...
                                >
                                    <ImageBackground
                                        style={{
                                            ...
                                            height: GLOBAL.Device_Height / 1.9,
                                        }}
                                        resizeMode={'cover'}
                                        resizeMethod={'resize'}
                                        source={{
